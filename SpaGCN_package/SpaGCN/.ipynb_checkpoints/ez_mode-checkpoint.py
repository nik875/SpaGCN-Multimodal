...
def detect_spatial_domains_ez_mode(adata, img, x_pixel, y_pixel, n_clusters, histology=True, s=1,
                                   b=49, p=0.5, r_seed=100, t_seed=100, n_seed=100):
...
def plot_spatial_domains_ez_mode(adata, domain_name, x_name, y_name,
                                 plot_color, size, save=True, save_dir="./domains.png"):
...
def detect_SVGs_ez_mode(adata, target, x_name, y_name, domain_name,
                        min_in_group_fraction, min_in_out_group_ratio, min_fold_change):
...
def plot_SVGs_ez_mode(adata, gene_list, x_name, y_name, plot_color,
                      size, show=False, save=True, save_dir="./"):
    for g in gene_list:
...
def detect_meta_genes_ez_mode(adata, target, domain_name, start_gene):
...
def plot_meta_genes_ez_mode(adata, x_name, y_name, meta_name, plot_color,
                            size, show=False, save=True, save_dir="./"):
    ax = sc.pl.scatter(
        adata,
        alpha=1,
